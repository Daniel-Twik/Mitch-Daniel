...
function create_addtc_buttons(selector) {
    ...
    for (let prod in prods) {
        ...
        add_btn.innerHTML = `
            <a><i class="fa fa-shopping-cart" style="font-size:24px"></i></a>
            <select name="tw-qty">
        ...
        add_btn.firstElementChild.firstElementChild.setAttribute('href', "#");
        add_btn.firstElementChild.firstElementChild.setAttribute('tw-ref', data_url);
        ...
        add_btn.firstElementChild.onclick = function() {
            add_btn.firstElementChild.firstElementChild.classList.remove("fa-shopping-cart");
            add_btn.firstElementChild.firstElementChild.classList.add("fa-spinner");
            add_btn.firstElementChild.firstElementChild.classList.add("fa-spin");
            // get product's json data from product page
            let data = Get(data_url);
            let qty = add_btn.firstElementChild.nextElementSibling.value;
            setTimeout(function(){ 
                // sort through product data for variant id and then trigger addtc
                find_and_add_product(data, qty);
            }, 1000);
            setTimeout(function() {
                add_btn.innerHTML = `<a><i class="fa fa fa-check" style="font-size:24px"></i></a>`;
            }, 1800);
        }         
    }
}
